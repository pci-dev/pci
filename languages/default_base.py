# -*- coding: utf-8 -*-
{
    ...
    "Picture": "Picture",
    "Picture right": "To illustrate your article, please add a picture (png or jpeg format) for which no rights are required (it can be a figure or a picture of your article). Pictures generated by IA cannot be used because some of them are too similar to pictures with copyrights.",
