# -*- coding: utf-8 -*-
{
    ...
    "Articles": "Articles",
    "Article(s) in Pre-submission stage": "Article(s) in Pre-submission stage",
    ...
    "More": "More",
    "More...": "More...",
    "Most recent DOI (or URL)": "Please add below the DOI of your preprint on the form https://doi.org/10.xxx (ie for bioRxiv, arXiv, OSF, Zenodo…). If your preprint is on HAL or an archive that does not provide a DOI, please add the URL (eg https://hal.science/hal-xxx). Do NOT add an URL such as https://www.biorxiv.org/content/xxx or https://zenodo.org/records/xxx, in the case of a preprint deposited on bioRxiv or Zenodo, respectively, but indicate the DOI of the preprint instead.",
    ...
    "Picture": "Picture",
    "Picture right": "To illustrate your article, please add a picture (png or jpeg format) for which no rights are required (it can be a figure or a picture of your article). AI-generated pictures cannot be used because some are too similar to copyrighted images.",
    ...
    "I accept to review this preprint, but I'll need more time to perform my review": "I accept to review this preprint, but I'll need more time to perform my review",
    ...
    "Thanks for your willingness to handle the evaluation of this preprint.": "Thanks for your willingness to handle the evaluation of this preprint.",
    "If the managing board agrees, you’ll receive an email inviting you to act as the recommender for this preprint": "If the managing board agrees, you’ll receive an email inviting you to act as the recommender for this preprint",
    "Request to handle the evaluation of this preprint": "Request to handle the evaluation of this preprint"
} # type: ignore
