# -*- coding: utf-8 -*-
{
    ...
    "Picture": "Picture",
    "Picture right": "I wish to add a small picture (png or jpeg format) for which no rights are required. Pictures generated by IA cannot be used because some of them are too similar to pictures with copyrights.",
