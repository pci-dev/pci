# -*- coding: utf-8 -*-
{
    ...
    "Picture": "Picture",
    "Picture right": "I wish to add a small picture (png or jpeg format) for which no rights are required. AI-generated pictures cannot be used because some are too similar to copyrighted images.",
