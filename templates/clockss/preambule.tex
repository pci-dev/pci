...
\usepackage[pdfborder={0 0 0},   
    ...
    linkcolor=link,
    urlcolor=link,
    citecolor=link]{hyperref}  % sets link border to white
...
\lhead{\ifnum\thepage=1 \includegraphics[width=16cm,height=4.6cm]{\logoname}\else \fi}  
\chead{}
\rhead{}
\cfoot{\thepage}
\rfoot{}
...
{\Huge
\fontseries{sb}\selectfont{\fontsize{12pt}{14pt}
\begin{spacing}{1}\preprinttitle\end{spacing}}}
\end{flushleft}
\vspace*{-1cm}
\begin{flushleft}
\Large
{\textit{\recommendationsubtitle}}
\bigbreak
...
\small{\textbf{Cite this recommendation as:}}\\
\small{\citeas}\\
\vspace*{0.2cm}
