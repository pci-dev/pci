...
-- Started on 2016-09-28 16:03:24 CEST
...
--
-- TOC entry 262 (class 1255 OID 87782634)
...
--
-- TOC entry 264 (class 1255 OID 87785079)
...
--
-- TOC entry 267 (class 1255 OID 87790493)
...
--
-- TOC entry 263 (class 1255 OID 87784973)
...
--
-- TOC entry 261 (class 1255 OID 87784972)
...
--
-- TOC entry 265 (class 1255 OID 87785221)
...
--
-- TOC entry 260 (class 1255 OID 87790460)
-- Name: search_articles(text[], text[], character varying, real); Type: FUNCTION; Schema: public; Owner: piry
--

CREATE FUNCTION search_articles(mythematics text[], mywords text[], mystatus character varying DEFAULT 'Recommended'::character varying, mylimit real DEFAULT 0.4) RETURNS TABLE(id integer, num integer, score double precision, title text, authors text, article_source character varying, doi character varying, abstract text, upload_timestamp timestamp without time zone, thematics character varying, keywords text, auto_nb_recommendations integer, status character varying, last_status_change timestamp without time zone)
    LANGUAGE plpgsql
    AS $_$
DECLARE
...
ALTER FUNCTION public.search_articles(mythematics text[], mywords text[], mystatus character varying, mylimit real) OWNER TO piry;

--
-- TOC entry 268 (class 1255 OID 87790605)
-- Name: search_recommenders(text[], text[]); Type: FUNCTION; Schema: public; Owner: piry
--

CREATE FUNCTION search_recommenders(mythematics text[], mywords text[]) RETURNS TABLE(id integer, num integer, score double precision, first_name character varying, last_name character varying, email character varying, uploaded_picture character varying, city character varying, country character varying, laboratory character varying, institution character varying, thematics character varying)
    LANGUAGE plpgsql
    AS $_$
DECLARE
  myThematicsRegexp text;
...
ALTER FUNCTION public.search_recommenders(mythematics text[], mywords text[]) OWNER TO piry;

--
-- TOC entry 266 (class 1255 OID 87790482)
-- Name: search_reviewers(text[], text[]); Type: FUNCTION; Schema: public; Owner: piry
--

CREATE FUNCTION search_reviewers(mythematics text[], mywords text[]) RETURNS TABLE(id integer, num integer, score double precision, first_name character varying, last_name character varying, email character varying, uploaded_picture character varying, city character varying, country character varying, laboratory character varying, institution character varying, thematics character varying, roles character varying)
    LANGUAGE plpgsql
    AS $_$
DECLARE
  myThematicsRegexp text;
...
ALTER FUNCTION public.search_reviewers(mythematics text[], mywords text[]) OWNER TO piry;
...
--
-- TOC entry 269 (class 1255 OID 87790492)
...
--
-- TOC entry 2107 (class 2604 OID 87785140)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2106 (class 2604 OID 87785127)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2109 (class 2604 OID 87785169)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2108 (class 2604 OID 87785156)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2110 (class 2604 OID 87790443)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2090 (class 2604 OID 87778734)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2096 (class 2604 OID 87779012)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2101 (class 2604 OID 87782592)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2104 (class 2604 OID 87785003)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2089 (class 2604 OID 87778707)
-- Name: id; Type: DEFAULT; Schema: public; Owner: piry
--
...
--
-- TOC entry 2123 (class 2606 OID 87778685)
...
--
-- TOC entry 2121 (class 2606 OID 87778669)
...
--
-- TOC entry 2115 (class 2606 OID 87778624)
...
--
-- TOC entry 2117 (class 2606 OID 87778632)
...
--
-- TOC entry 2119 (class 2606 OID 87778653)
...
--
-- TOC entry 2113 (class 2606 OID 87778613)
...
--
-- TOC entry 2157 (class 2606 OID 87785145)
...
--
-- TOC entry 2163 (class 2606 OID 87785174)
...
--
-- TOC entry 2153 (class 2606 OID 87785132)
...
--
-- TOC entry 2155 (class 2606 OID 87785134)
...
--
-- TOC entry 2159 (class 2606 OID 87785161)
...
--
-- TOC entry 2161 (class 2606 OID 87785163)
...
--
-- TOC entry 2125 (class 2606 OID 87778701)
...
--
-- TOC entry 2141 (class 2606 OID 87784950)
...
--
-- TOC entry 2144 (class 2606 OID 87784953)
...
--
-- TOC entry 2127 (class 2606 OID 87778712)
...
--
-- TOC entry 2165 (class 2606 OID 87790447)
...
--
-- TOC entry 2129 (class 2606 OID 87778736)
...
--
-- TOC entry 2132 (class 2606 OID 87779014)
...
--
-- TOC entry 2137 (class 2606 OID 87782597)
...
--
-- TOC entry 2139 (class 2606 OID 87782599)
...
--
-- TOC entry 2149 (class 2606 OID 87785005)
...
--
-- TOC entry 2147 (class 2606 OID 87784959)
...
--
-- TOC entry 2167 (class 2606 OID 87790611)
...
--
-- TOC entry 2134 (class 2606 OID 87790609)
...
--
-- TOC entry 2151 (class 2606 OID 87785084)
...
--
-- TOC entry 2142 (class 1259 OID 87784951)
...
--
-- TOC entry 2145 (class 1259 OID 87784971)
...
--
-- TOC entry 2130 (class 1259 OID 87785218)
...
--
-- TOC entry 2135 (class 1259 OID 87782433)
...
--
-- TOC entry 2194 (class 2620 OID 87785081)
...
--
-- TOC entry 2195 (class 2620 OID 87785082)
-- Name: auto_last_change_trigger; Type: TRIGGER; Schema: public; Owner: piry
--
...
--
-- TOC entry 2197 (class 2620 OID 87790459)
-- Name: auto_last_change_trigger; Type: TRIGGER; Schema: public; Owner: piry
--
...
--
-- TOC entry 2191 (class 2620 OID 87785080)
...
--
-- TOC entry 2198 (class 2620 OID 87790500)
...
--
-- TOC entry 2196 (class 2620 OID 87790613)
-- Name: auto_nb_agreements_trigger; Type: TRIGGER; Schema: public; Owner: piry
--
...
--
-- TOC entry 2193 (class 2620 OID 87782637)
...
--
-- TOC entry 2190 (class 2620 OID 87785075)
...
--
-- TOC entry 2192 (class 2620 OID 87785246)
...
--
-- TOC entry 2189 (class 2620 OID 87782453)
...
--
-- TOC entry 2172 (class 2606 OID 87778686)
...
--
-- TOC entry 2171 (class 2606 OID 87778670)
...
--
-- TOC entry 2169 (class 2606 OID 87778638)
...
--
-- TOC entry 2168 (class 2606 OID 87778633)
...
--
-- TOC entry 2170 (class 2606 OID 87778654)
...
--
-- TOC entry 2185 (class 2606 OID 87785146)
...
--
-- TOC entry 2186 (class 2606 OID 87785175)
...
--
-- TOC entry 2174 (class 2606 OID 87779040)
...
--
-- TOC entry 2173 (class 2606 OID 87778800)
...
--
-- TOC entry 2188 (class 2606 OID 87790453)
...
--
-- TOC entry 2177 (class 2606 OID 87784977)
...
--
-- TOC entry 2176 (class 2606 OID 87779025)
...
--
-- TOC entry 2178 (class 2606 OID 87779015)
...
--
-- TOC entry 2179 (class 2606 OID 87779020)
...
--
-- TOC entry 2175 (class 2606 OID 87782619)
...
--
-- TOC entry 2181 (class 2606 OID 87784960)
...
--
-- TOC entry 2182 (class 2606 OID 87784965)
...
--
-- TOC entry 2187 (class 2606 OID 87790448)
...
--
-- TOC entry 2184 (class 2606 OID 87785011)
...
--
-- TOC entry 2183 (class 2606 OID 87785006)
...
--
-- TOC entry 2180 (class 2606 OID 87782428)
...
-- Completed on 2016-09-28 16:03:25 CEST
