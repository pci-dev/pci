...
parallelSubmissionAllowed = config.getboolean("config", "parallel_submission", fallback=False)
...
#     mail_vars["recomm_limit_days"] = config.get("config.recomm_limit_days", default=50)
...
#     else:
#         sender = "The Managing Board of " + config.get("app.longname") + " on behalf of " + common_small_html.mkUser(recomm.recommender_id).flatten()
...
#     mail_vars["destAddress"] = config.get("contacts.generic_contact")
