...
def mkReviewerInfo(auth, db, user):
    ...
    if user:
        ...
        anchor = DIV(
            ...
            DIV(DIV(DIV(DIV(H4(B("Area of Expertise"), _class="modal-title", _id="myModalLabel"),_class="modal-header"), DIV(user.cv or "",_class="modal-body"),_class="modal-content"),_class="modal-dialog", _role="document"),_class="modal fade", _id="myModal", _tabindex="-1", _role="dialog",  **{'_aria-labelledby' :'myModalLabel'}),
        )
    return anchor
