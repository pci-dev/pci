...
class ClockssUpload:
    ...
    def _build_latex_content_from_template(self):
        ...
        simple_variables: Dict[str, Any] = {
            ...
            'PCI_COMMAND': "Peer Community In Mathematical and Computational Biology",#str(myconf.take("app.description")),
    ...
    def _inner_html(self, html: ...):
        return (html.text or '') + ''.join([html.tostring(child) for child in html.iterchildren()])
    ...
    def _replace_list_reference_in_template(self, var_title: str, var_content: Optional[List[Any]], template: str):
        ...
        for line in var_content:
            content.write(f"[{i}] {line}\n")
        return self._replace_var_in_template(var_title, content.getvalue(), template, True)
