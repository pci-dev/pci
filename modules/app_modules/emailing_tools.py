...
contact = config.get("contacts", "managers")

pciRRactivated = config.getboolean("config", "registered_reports", fallback=False)
...
#     mail.settings.server = config.take("smtp.server")
#     mail.settings.sender = config.take("smtp.sender")
#     mail.settings.login = config.take("smtp.login")
#     mail.settings.tls = config.get("smtp.tls", default=False)
#     mail.settings.ssl = config.get("smtp.ssl", default=False)
#     return mail
...
#         appDescription=config.take("app.description"),
#         appName=config.take("app.name"),
#         appLongName=config.take("app.longname"),
#         longname=config.take("app.longname"),  # DEPRECATED: for compatibility purposes; to be removed after checking
#         appThematics=config.take("app.thematics"),
#         appContactMail=config.take("contacts.managers"),
#         appGenericContactMail=config.take("contacts.generic_contact"),
#         appContactLink=A(config.take("contacts.managers"), _href="mailto:" + config.take("contacts.managers")),
#         siteUrl=URL(c="default", f="index", scheme=config.take("alerts.scheme"), host=config.take("alerts.host"), port=config.take("alerts.port")),
...
#     mail_vars["description"] = config.take("app.description")
#     mail_vars["longname"] = config.take("app.longname") # DEPRECATED
#     mail_vars["appLongName"] = config.take("app.longname")
#     mail_vars["appName"] = config.take("app.name")
#     mail_vars["thematics"] = config.take("app.thematics")
...
#         if recommender:
#             mail_vars["sender"] = "The Managing Board of " + config.get("app.longname") + " on behalf of " + common_small_html.mkUser(recommendation.recommender_id).flatten()
...
#     mail_vars['unconsider_limit_days'] = config.get("config.unconsider_limit_days", default=20)
