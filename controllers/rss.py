...
def _rss_cacher(maxArticles):
    ...
    query = db(
        ...
        db.t_articles.guide_read,
        db.t_articles.approvals_obtained,
        db.t_articles.human_subject_consent_obtained,
        db.t_articles.lines_numbered,
        db.t_articles.funding_sources_listed,
        db.t_articles.conflicts_of_interest_indicated,
        db.t_articles.no_financial_conflict_of_interest,
