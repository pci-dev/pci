...
def _UserMenu():
    ...
    nWaitingForReviewer = db((db.t_articles.is_searching_reviewers == True) & ((db.t_articles.status == "Under consideration") | (db.t_articles.status == "Scheduled submission under consideration"))).count()
