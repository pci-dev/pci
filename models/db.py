...
db.define_table(
    ...
    Field("keywords", type="string", length=4096, label="Keywords (optional)", requires=IS_EMPTY_OR(IS_LENGTH(4096, 0))) if not pciRRactivated else\
        RequiredField("keywords", type="string", length=4096, label="Keywords", requires=IS_EMPTY_OR(IS_LENGTH(4096, 0))),
        ...
        requires=IS_EMPTY_OR(
            IS_IN_SET(
                (
                    ...
                    "At least some data/evidence that will be used to answer the research question has been previously accessed by the authors (e.g. downloaded or otherwise received), but the authors certify that they have not yet observed ANY part of the data/evidence [Level 3]",
                    ...
                    "At least some of the data/evidence that will be used to answer the research question has been accessed and observed by the authors, including key variables, but the authors certify that they have not yet performed ANY of their preregistered analyses, and in addition they have taken stringent steps to reduce the risk of bias [Level 1]",
                    "At least some of the data/evidence that will be used to answer the research question has been accessed and observed by the authors, including key variables, AND the authors have already conducted (and know the outcome of) at least some of their preregistered analyses [Level 0]",
                )
            )
        ),
        widget=SQLFORM.widgets.radio.widget,
